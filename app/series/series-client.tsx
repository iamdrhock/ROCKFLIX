          ...
          {totalPages > 1 && (
            <Pagination>
              <PaginationContent>
                <PaginationItem>
                  <PaginationPrevious
                    href={`/series?page=${currentPage > 1 ? currentPage - 1 : 1}`}
                    onClick={(e) => {
                      e.preventDefault()
                      if (currentPage > 1) {
                ...
                <PaginationItem>
                  <PaginationNext
                    href={`/series?page=${currentPage < totalPages ? currentPage + 1 : totalPages}`}
                    onClick={(e) => {
                      e.preventDefault()
