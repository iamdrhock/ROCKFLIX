...
export default function CompleteProfilePage() {
  ...
  const checkProfile = async (userId: string) => {
    try {
      ...
      console.error("[NextAuth] Error checking profile:", error)
    }
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("[NextAuth] Uploading profile picture if provided")
      ...
      console.log("[NextAuth] Completing profile via API")

      // Call API route to complete profile (handles database operations server-side)
      const response = await fetch("/api/auth/complete-profile", {
        method: "POST",
        headers: {
      ...
      console.log("[NextAuth] Profile completed successfully, redirecting to home")
      ...
      <div className="w-full max-w-sm">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set up your username and password</CardDescription>
          </CardHeader>
          <CardContent>
