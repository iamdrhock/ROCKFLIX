-- Rename columns to camelCase as PostgresAdapter expects
-- The error "column a.userId does not exist" confirms the adapter uses camelCase
...
-- Update foreign key references (PostgreSQL handles this automatically with column rename)
